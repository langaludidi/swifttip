...
export default async function DisputeQueuePage(){
  ...
  <section className="trust-card"><span className="trust-icon">i</span><div><strong>No hidden Worker clawback</strong><p>The system records the dispute and Settlement truth separately. It does not create an internal Worker debt balance or silently deduct future gratuities.</p></div></section></main>;
}
